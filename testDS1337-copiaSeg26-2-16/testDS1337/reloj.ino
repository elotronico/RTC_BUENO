...
void RTCrenuevaInterrupcion(void){
	...
	if(minutoActual < (uint8_t)59){			
		...
		Serial.println("1-alarma programada para: " + (String)diaActual + "/" + (String)mesActual + "/"  + (String)anoActual  + " " + (String)horaActual + ":" + (String)(minutoActual+1));
	}
...
void actualizarPantallaPpalLCD(){
	...
	//----------------imprimimos el estado de las salidas ---------------------
	lcd.setCursor(2,2);
