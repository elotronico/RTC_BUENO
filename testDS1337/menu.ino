	...
	// ------------------ Menu 1-------------------------
		...
		if(menuPosY==0){
			if(teclaPulsada!='o'){
				...
				lcd.clear();
				lcd.print("funcion 1.0");//aqui llamamos a la accion
				delay(1000);
			}
		}
		else if(menuPosY==1){
			if(teclaPulsada!='o'){
				...
				lcd.clear();
				lcd.print("funcion 1.1");//aqui llamamos a la accion
				delay(1000);
			}
		}
			...
			if(teclaPulsada!='o'){
				...
				lcd.clear();
				lcd.print("funcion 1.2");
				delay(1000);//aqui llamamos a la accion
			}
		}	
	}
	//---------------------------------------------------
...
void actualizarMenuLcd()
{
	...
	//--------------MENU 1---------------------------
		...
		if(menuPosY==0){						//menu 1.0
			...
			lcd.print("1.1 >Cambiar hora");
			lcd.setCursor(0,1);
			lcd.print("1.2  Cambiar Fecha");
			lcd.setCursor(0,2);
			lcd.print("1.3  Vacio");
			lcd.setCursor(0,3);
			lcd.print("1.4  Vacio");
	...
	//--------------MENU 2---------------------------
		...
		else if(menuPosY<=largoSubmenus[menuPosX]){
...
void accionMenu()
{
	...
	if(menuPosX==1){		
		...
		else if(menuPosY ==3){			//submenu 1.3 
			
		}	
		else if  (menuPosY==4){			//submenu 1.4 
			
		}		 
		else if  (menuPosY==5){			//submenu 1.5 
			
		}		
		else if  (menuPosY==6){			//submenu 1.6 
	...
	//--------------MENU 2---------------------------
		...
		editarProgramacion();		//accedemos a editar la programacion horaria (que corresponde con menuPosY)
	}
